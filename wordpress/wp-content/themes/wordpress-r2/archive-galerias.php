...
<div id="content" class="reading reading-archive-galerias">
	<!-- BREADCRUMB -->
	...
	<!-- BLOG ROLL -->
	<section id="blog-roll" class="archive-galerias">
				...
				<div class="row">
					<div class="col-md-12">
						...
						?>
							...
							<article id="post-<?php echo $post->ID; ?>" class="post post-excerpt post-<?php echo $post->ID; ?>">
